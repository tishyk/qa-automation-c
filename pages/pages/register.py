...
from pages.input.register import RegisterPageInput
from pages.locators.register import RegistrationPage as RP_Locators
from pages.pages import Page
from pages.pages.base import BasePage
from pages.map.urls import RegisterPageUrl, Url
